...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // UserDefaults初期値
    [[MKSUserDefault sharedInstance] setDefaultParam:@{
        kMKSUserDefaultsKeySearchDistance : @3,
        kMKSUserDefaultsKeySearchTraffic : @0
    }];
...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    // temporary interruptions (such as an
    // incoming phone call or SMS message) or when the user quits the application and it begins the transition to the
    // background state.
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    // was previously in the background,
...
- (NSURL *)applicationDocumentsDirectory {
    ...
    // "jp.test.yuto.MKMapSample" in the application's
    // documents directory.
    return
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MKMapSample" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    // having added the store for the application
    // to it.
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MKMapSample.sqlite"];
    NSError *error = nil;
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType
        ...
        // shipping application, although it may be
...
- (void)saveContext {
    ...
    if (managedObjectContext != nil) {
        ...
        if ([managedObjectContext hasChanges] && ![managedObjectContext save:&error]) {
            ...
            // a shipping application, although it may
